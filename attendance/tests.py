...
class FormTestCase(TestCase):
    def test_clean_username_exception(self):
        ...
        Profile.objects.create_user(username='test-user')
    ...
    def test_clean_username(self):
        # Create a player so that this username we're testing is already taken
        Profile.objects.create_user(username='test-user2')
...
class ViewTestCase(TestCase):
    ...
    def test_register_page(self):
        ...
        self.assertTrue(Profile.objects.filter(username=TEST_USER).exists())
    ...
    def test_profile_page(self):
        ...
        password = 'passsword'
        user = Profile.objects.create_user(username='test-user', email='test@test.com', password=password)
...
class SeleniumTests(LiveServerTestCase):
    ...
    def test_app_login(self):
        # Create a superuser
        Profile.objects.create_user('user', 'user@test.com', 'apassword')
        # let's open the admin login page
